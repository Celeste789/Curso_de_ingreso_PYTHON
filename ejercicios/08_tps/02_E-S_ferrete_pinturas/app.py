...
class App(customtkinter.CTk):
    ...
    def btn_convertir_c_f_on_click(self):
        temperatura_centigrados = float(self.txt_temperatura_c.get())
        resultado = (temperatura_centigrados * 5/9) + 32
        alert(title="Temperatura C a F", message = resultado)

    def btn_convertir_f_c_on_click(self):
        temperatura_farenheit = float(self.txt_temperatura_f.get())
        resultado = (temperatura_farenheit - 32) * 5/9
        alert(title="Temperatura F a C", message = resultado)
